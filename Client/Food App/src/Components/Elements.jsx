            ...
            <div className="mt-32 ml-[3rem] md:block hidden">
                ...
                <motion.div
                    ...
                    <div className="mt-10">
                        ...
                        <h1 className='text-2xl  ml-14 mt-2'>Pizza</h1>
                    </div>
                    ...
                    <div className='mt-8 ml-14'>
                        ...
                        <h1 className='text-[1.5rem] ml-8'>Briyani</h1>
                    </div>
                    <div className='mt-8 ml-14'>
                        ...
                        <h1 className='text-2xl  ml-14 mt-1'>Chinese</h1>
                    </div>
                    <div className='mt-8 ml-12'>
                        ...
                        <h1 className='text-2xl  ml-8 mt-1'>Momos</h1>
                    </div>
                    <div className='mt-8 ml-14'>
                        ...
                        <h1 className='text-2xl  ml-10 mt-2'>Cake</h1>
                    </div>
                    <div className=' ml-14'>
                        ...
                        <h1 className='text-2xl ml-14 mt-2'>Pulao</h1>
                    </div>
                </motion.div>
